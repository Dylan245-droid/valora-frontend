...
export default function EntityModal({ isOpen, onClose, entity, onSuccess }: EntityModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true)
        try {
            const payload = { name, code, address, phone }
            if (entity) {
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="md:col-span-2">
                                            ...
                                            <input
                                                type="text"
                                                required
                                                placeholder="Ex: Global Corp SAS"
                                        ...
                                        <div>
                                            <label className="block text-sm font-semibold text-gray-700 mb-1">Code interne</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="md:col-span-2">
                                            <label className="block text-sm font-semibold text-gray-700 mb-1">Adresse Siège</label>
                                            <input
                                                type="text"
